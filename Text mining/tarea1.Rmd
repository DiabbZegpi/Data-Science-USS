...
chat_train <- chat_train %>% 
  mutate(sender = if_else(sender %in% sender_target,
                          sender,
                          "Otro"),
         sender = factor(sender), skip = FALSE)
...
Por otra parte, el modelo multinomial supera ampliamente al bayesiano, pero sigue teniendo un desempeño pobre-moderado. Al examinar el ajuste de este modelo se puede identificar a las variables con mayor influencia sobre la predicción.
