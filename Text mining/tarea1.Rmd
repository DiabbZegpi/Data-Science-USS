...
```{r echo=FALSE}
bayes_fit <- readRDS(here("Text Mining", "bayes_fit.rds"))
multinom_fit <- readRDS(here("Text Mining", "multinom_fit.rds"))
bayes_train_pred <- readRDS(here("Text Mining", "bayes_train_fit.rds"))
multinom_train_pred <- readRDS(here("Text Mining", "multinom_train_pred.rds"))
```
...
```{r echo=FALSE}
multinom_test_pred <- readRDS(here("Text Mining", "multinom_test_pred.rds"))
```
