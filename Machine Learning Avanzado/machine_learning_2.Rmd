...
collect_predictions(rf_res) %>% 
  ...
  geom_line(show.legend = FALSE, alpha = .7, size = .7, aes(group = .config), color = "gray50") +
  stat_summary(geom = "line", fun = mean, color = "#a92759", size = 1) +
  geom_abline(linetype = 2) +
  annotate(geom = "text", x = .35, y = .65, size = 4.5, family = "Noto Sans", fontface = "italic",
           label = "ROC AUC media = 0.880\nStd. Error = 0.0115", hjust = 0) +
  coord_fixed() +
