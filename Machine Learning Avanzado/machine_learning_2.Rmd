...
La mejor combinación de hiperparámetros resultó ser trees: 496, mtry: 5 y min_n: 7. Esta combinación alcanzó un accuracy estimado de 0.843, con un error estándar estimado de 0.0161. Paralelamente, el área media bajo la curva ROC estimada es 0.884, con error estándar de 0.0161.
...
collect_predictions(rf_res) %>% 
  ...
  annotate(geom = "text", x = .45, y = .35, size = 4.5, family = "Noto Sans", fontface = "italic",
           label = "ROC AUC media = 0.884\nStd. Error = 0.0161", hjust = 0) +
  coord_fixed() +
